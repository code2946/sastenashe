  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }: { className?: string; orientation?: 'left' | 'right' | 'up' | 'down'; size?: number; disabled?: boolean; [key: string]: any }) => {
          if (orientation === 'left') {
            return (
        ...
        WeekNumber: ({ children, ...props }: { children?: React.ReactNode; week?: any; [key: string]: any }) => {
          return (
            <td {...props}>
